...
class NovelUpReadingInterface extends StatefulWidget {
  const NovelUpReadingInterface({super.key, required this.storySlug, required this.chapterNumber, required this.chapterTitle});
  final String storySlug;
  final String chapterNumber;
  final String chapterTitle;
  
  @override
  State<NovelUpReadingInterface> createState() => _NovelUpReadingInterfaceState();
}
